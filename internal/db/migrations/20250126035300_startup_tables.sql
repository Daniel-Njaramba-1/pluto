...
CREATE TABLE IF NOT EXISTS product_metrics (
    ...
    base_price DECIMAL(10, 2) NOT NULL CHECK (base_price >= 0), -- Base price before adjustment - static
...
ALTER TABLE cart_items_history DROP CONSTRAINT IF EXISTS cart_items_history_cart_id_fkey;
ALTER TABLE cart_items_history DROP CONSTRAINT IF EXISTS cart_items_history_order_item_id_fkey;
...
DROP INDEX IF EXISTS idx_categories_section_id;
